jQuery(document).ready(function($) {
    ...
    // UserToggle Function
    //***************************
    jQuery('.careplus-user-list li a.fa-user').on("click", function(){
          jQuery('.careplus-user-box').fadeToggle('slow');
          return false;
      });
      jQuery('html').on("click", function() { jQuery(".careplus-user-box").fadeOut(); });
